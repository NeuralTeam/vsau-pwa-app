...
const Feedback = () => {
	...
	return (
		<div className='absolute w-screen  h-screen flex items-center dark:text-white text-dark-main justify-center bg-light-light dark:bg-dark-dark bg-opacity-80 z-30 left-0 top-0 p-4'>
